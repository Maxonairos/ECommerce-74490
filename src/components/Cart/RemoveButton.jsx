...
const RemoveButton = () => {
  return (
    <div className="group relative flex h-14 w-14 flex-col items-center justify-center overflow-hidden rounded-xl border-2 border-green-800 bg-seagreen hover:bg-green-600">
