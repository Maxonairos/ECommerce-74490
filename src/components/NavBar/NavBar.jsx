    ...
    <nav className="bg-success-subtle">
          ...
          <div className="flex flex-1 items-center justify-evenly sm:items-stretch sm:justify-center">
            ...
            <div className="hidden sm:ml-6 sm:block">
              <ul className="flex space-x-4 ">
                ...
                <NavLink className={({isActive})=>(isActive ? "bg-gray-900 font-black text-black self-center": "") +" self-center rounded-md px-2 py-1 text-sm font-bold text-gray-500 hover:bg-gray-700 hover:text-black"} to="/cart">{<CartWidget/>}</NavLink>
      ...
      <div className="sm:hidden" id="mobile-menu">
        ...
        <ul>
                ...
                <NavLink className={({isActive})=>(isActive ? "bg-gray-900 font-black text-black self-center": "") +" self-center rounded-md px-2 py-1 text-sm font-bold text-gray-500 hover:bg-gray-700 hover:text-black"} to="/cart">Carrito {<CartWidgetMobile/>}</NavLink>
              </ul>
        </div>
      </div>
    </nav>
