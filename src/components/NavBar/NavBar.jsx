    ...
    <nav className="bg-success-subtle">
      ...
      <div className="sm:hidden" id="mobile-menu">
        ...
        <ul>
                ...
                <NavLink className={({isActive})=>(isActive ? "bg-gray-900 font-medium text-white": "") +" rounded-md px-2 py-1 text-sm font-bold text-gray-500 hover:bg-gray-700 hover:text-white"} to="/cart">Carrito {<CartWidgetMobile/>}</NavLink>
              </ul>
        </div>
      </div>
    </nav>
