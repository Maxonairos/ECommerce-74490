...
const Item = ({product}) => {
  return (
      <div className="m-2 p-2 max-w-sm bg-white border border-gray-300 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 hover:scale-102 transition delay-100 duration-200 ease-in-out">
              ...
              <Link className="inline-flex self-end px-3 py-2 text-sm font-medium text-center text-white bg-gradient-to-r from-green-500 to-seagreen rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" to={`/detalle/${product.id}`}>Ver Detalles</Link>
              </div>
