...
const BuySuccess = ({orderId}) => {
    return (
        <div className="max-w-2xl bg-white rounded-lg shadow-md p-8">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Tu orden ha sido enviada correctamente 😀</h2>
            ...
            <p className="inline-flex text-xl font-bold text-gray-900 mb-4">Orden:</p>
            <p className="inline-flex text-xl font-bold text-gray-500 mb-4">"{orderId}"</p>
            <div className="">
