...
export const ItemCount = ({stock, addProduct}) => {
  ...
  return (
    <div className="w-40 flex-col justify-center rounded-xl bg-grey border">
      ...
      <button className="inline-flex items-end px-3 py-2 text-sm font-medium text-center text-white bg-seagreen rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" onClick={ addAndReset }>Agregar al Carrito</button>
      </div>
