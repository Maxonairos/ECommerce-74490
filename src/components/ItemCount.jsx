  ...
  return (
    <div className="flex self-center justify-center">
      ...
      <div className="flex justify-center py-2">
        <button className="inline-flex justify-center px-2 py-2 text-sm font-medium text-center text-white bg-gradient-to-r from-green-500 to-seagreen rounded-xl hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" onClick={handleClickDecrement}>{<FaCircleMinus size={30}/>}</button>
        <p className="inline-flex px-8 p-2 justify-center rounded-xl bg-grey border text-justify font-bold">{count}</p>
        <button className="inline-flex items-center p-2 text-sm font-medium text-center text-white bg-gradient-to-r from-green-500 to-seagreen rounded-xl hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" onClick={handleClickIncrement}>{<FaCirclePlus size={30}/>}</button>
        </div>
